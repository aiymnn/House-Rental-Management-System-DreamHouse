...
<div class="details-container">
    ...
    <div class="card-body" id="paymentDetailBody">
        ...
        <button type="button" class="btn" style="background-color: #023d90; color: white;" id="viewMapBtn">
            View Map
        </button>
        <!-- Map Modal -->
...
@foreach ($contracts as $contract)
    <div class="container agent-details-container">
        <a href="{{url('agent/contract/view/'.$contract->id.'') }}" class="btn float-end" style="background-color: #023d90; color: white;">View Contract</a>
        ...
        <div class="card-body" style="display: none;" id="agentDetailBody">
            ...
            <h3 class="text-center text-secondary p-3">No tenant assigned for this property.</h3>
            @else --}}
