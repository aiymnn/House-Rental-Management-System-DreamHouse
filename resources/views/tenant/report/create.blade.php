...
<div class="details-container">
    ...
    <div class="card-body" id="paymentDetailBody">
        <form action="{{ url('tenant/report/create') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" rows="2" aria-describedby="emailHelp" placeholder="Describe your problem here." name="description">{{ old('description') }}</textarea>
