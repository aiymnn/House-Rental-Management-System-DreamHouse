...
<div class="details-container">
    <a href="{{ url('staff/report') }}" class="btn float-end" style="background-color: #17395e; color: white;" >Back</a>
    <div class="details-header" id="paymentDetailHeader">
        <h4>Reply Complaint
        </h4>
    </div>
    <div class="card-body" id="paymentDetailBody">
        <form action="{{ url('staff/report/reply/'.$reports->id.'') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="form-section submit-button">
                <button type="submit" class="btn" style="background-color: #17395e; color: white;">Remark</button>
            </div>
        </form>
    </div>
</div>
