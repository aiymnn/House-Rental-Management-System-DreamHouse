...
<div class="details-container">
    ...
    <div class="card-body" id="paymentDetailBody">
        <form action="{{ url('landlord/property/edit/'.$property->id.'') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                <div id="fileInputContainer" class="mb-3">
                    ...
                    <button type="button" id="chooseImagesBtn" class="btn" style="background-color: #023d90; color: white;"><i class="fa-solid fa-camera"></i></button>
                    <span>Add More Image</span>
                    <span style="color: grey;">.JPEG,.PNG,.JPG</span>
                  </div>
