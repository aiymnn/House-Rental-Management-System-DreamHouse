...
<div class="details-container">
    <a href="{{ route('landlord_property')}}" class="btn float-end" style="background-color: #022d6a; color: white;">Back</a>
    ...
    <div class="card-body" id="paymentDetailBody">
        ...
        <button type="button" class="btn btn-primary" id="viewMapBtn">
            View Map
        </button>
        <!-- Map Modal -->
